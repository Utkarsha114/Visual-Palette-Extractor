...
root=Tk()
root.title("Visual Palette Extractor")
...
#icon
image_icon=PhotoImage(file="G:\Git Projects\Color Detection Tool\icon.png")
...
logo=PhotoImage(file="G:\Git Projects\Color Detection Tool\logo.png")
...
id7=colors2.create_rectangle((10,50,50,100), fill="#db4035")
...
#select image
selectimage=Frame(frame, width=340, height=350, bg="grey")
...
Button(selectimage,text="Identify Colors",  width=12,height=1, font="arial 14 bold", command=findColors).place(x=176,y=300)
